    ...
    <div class="login-box">
      <van-nav-bar @click-right="goPage('Home')">
        <template #left>
          <div class="left-text">
            <div class="logo">
              <img class="auto-img" src="../assets/image/tabbar_18.png" alt />
            </div>
        ...
        <div class="login-form-box">
          <van-form>
            ...
            <van-field v-model="userInfo.validCode" center clearable label="邮箱验证码" placeholder="请输入邮箱验证码">
              <template #button>
                <van-button size="small" color="#4d72e8" :disabled="isSend" @click="sendValidCode">{{text}}</van-button>
              </template>
            </van-field>
            ...
            <div class="login-btn">
              <van-button round block native-type="submit" color="#4d72e8" @click="commit">提&nbsp;&nbsp;交</van-button>
            </div>
          </van-form>
        </div>
      </div>
